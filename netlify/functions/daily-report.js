...
import { getYesterdayBookings, getTodayTours, getWeekSummary } from './google-sheets.js';
import { sendLongMessage, sendErrorAlert } from './telegram.js';
import { generateDailyReport } from './ai-employees.js';
...
export const handler = schedule('0 22 * * *', dailyReportTask);
