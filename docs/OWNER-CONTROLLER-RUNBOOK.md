...
운영 Firestore 규칙이 본인 기기의 단건 조회도 거부하는 문제를 확인하여, 운영자에게
최소 GET 조건의 수정·배포 승인을 받았다(2026-09-07). 아래는 알림 UI의 동작 계약이며
화면 검사만으로 실제 기기 등록·수신이나 운영 규칙 배포 완료를 판단하지 않는다. 변경 범위와 모의검사 결과는
