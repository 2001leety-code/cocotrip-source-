...
export const adminAiOpsCopy: Record<Language, AdminAiOpsCopy> = {
  ko: {
    ...
    partialErrorDetail: '없는 자료로 계산하지 않았으며, 나머지 원본은 계속 표시합니다.',
  ...
  en: {
    ...
    allSourcesResponded: 'All responded',
    sourceFailed: 'Failed',
    ...
    partialErrorDetail: 'Unavailable sources were not counted as empty. Other source data is still shown.',
  ...
  ja: {
    ...
    partialErrorDetail: '取得できないデータを0件として計算せず、ほかのデータは引き続き表示しています。',
  ...
  zh: {
    ...
    partialErrorDetail: '未将无法获取的数据视为空，其他来源的数据仍会显示。',
