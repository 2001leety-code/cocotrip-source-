...
// fetch (작은 spinner fallback). Main bundle 에서 ZoneRecommender + 의존하는 zone
// data 일부 분리 → ~5 KB gzip 절감 추정. zoneData NAME_TO_ZONE_CITY_KEY map 은
// WizardForm/index.tsx 가 static import 라 main 에 그대로 (작음).
