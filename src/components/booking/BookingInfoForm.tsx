      ...
      <div style={{ flex: '1 1 460px', minWidth: 0, display: 'flex', flexDirection: 'column', gap: 24 }}>
        ...
        <div style={{ ...C.card, display: 'flex', gap: 14, alignItems: 'center' }}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: 6, fontSize: 12, color: '#00D28C', marginTop: 8, fontWeight: 600 }}>✓ 투어 48시간 전까지 무료 취소 · 전액 환불</div>
          </div>
        </div>
      ...
      <div style={{ flex: '1 1 300px', maxWidth: 360, minWidth: 280, position: 'sticky', top: 74, display: 'flex', flexDirection: 'column', gap: 14 }}>
        ...
        <div style={{ ...C.card, padding: 20 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            <div><div style={{ fontSize: 13, fontWeight: 700, color: '#00D28C' }}>무료 취소</div><div style={{ fontSize: 12, color: 'rgba(255,255,255,0.45)', lineHeight: 1.5 }}>투어 48시간 전까지 — 전액 환불</div></div>
            <div><div style={{ fontSize: 13, fontWeight: 700, color: '#FFB020' }}>부분 환불</div><div style={{ fontSize: 12, color: 'rgba(255,255,255,0.45)', lineHeight: 1.5 }}>24~48시간 전 50% 환불 · 24시간 이내 환불 불가 (회원 등급별 상이)</div></div>
          </div>
        </div>
