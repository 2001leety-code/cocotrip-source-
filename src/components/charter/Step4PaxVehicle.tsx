...
export function Step4PaxVehicle({ state, patch, language = 'en' }: Props) {
  ...
  return (
    <div className="space-y-5">
      <div>
        <label className="block text-[11px] uppercase tracking-wider text-white/30 mb-2">{i18n.paxLabel}</label>
        ...
        <p className="text-[11px] text-white/40 mt-2">{i18n.maxCapacityNote(vehicle, paxCap)}</p>
      </div>
