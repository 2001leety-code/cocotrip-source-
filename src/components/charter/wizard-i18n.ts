...
export interface WizardI18n {
  ...
  addons: string; englishGuide: string; picket: string; childSeat: string; notes: string;
  ...
  roundTripDiscount: string; onewayLabel: string;
...
const base: Record<WizardLang, WizardI18n> = {
  ko: {
    ...
    destCustomLabel: '기타 목적지 직접 입력', destCustomPlaceholder: '예: 양평 두물머리',
    selectOriginFirst: '출발지·서비스 유형을 먼저 선택해주세요.',
    minutesUnit: '분',
    paxLabel: '인원수', vehicleLabel: '차종', recommendedTag: '추천', maxUnit: '인', groupLabel: '단체',
    ...
    addons: '추가 옵션', englishGuide: '영어 가이드', picket: '픽켓', childSeat: '카시트', notes: '요청사항 (선택)',
    ...
    roundTripDiscount: '왕복 할인', onewayLabel: '편도 거리',
  ...
  en: {
    ...
    destCustomLabel: 'Custom destination', destCustomPlaceholder: 'e.g. Yangpyeong Dumulmeori',
    selectOriginFirst: 'Please select origin and service first.',
    minutesUnit: 'min',
    paxLabel: 'Pax', vehicleLabel: 'Vehicle', recommendedTag: 'recommended', maxUnit: 'pax', groupLabel: 'Group',
    ...
    addons: 'Add-ons', englishGuide: 'English guide', picket: 'Picket', childSeat: 'Child seat', notes: 'Notes (optional)',
    ...
    roundTripDiscount: 'Round-trip discount', onewayLabel: 'one-way',
  ...
  ja: {
    ...
    destCustomLabel: '目的地を直接入力', destCustomPlaceholder: '例: 楊平 トゥムルモリ',
    selectOriginFirst: '出発地とサービスを先に選択してください。',
    minutesUnit: '分',
    paxLabel: '人数', vehicleLabel: '車種', recommendedTag: 'おすすめ', maxUnit: '名', groupLabel: '団体',
    ...
    addons: '追加オプション', englishGuide: '英語ガイド', picket: 'ピケット', childSeat: 'チャイルドシート', notes: 'ご要望（任意）',
    ...
    roundTripDiscount: '往復割引', onewayLabel: '片道',
  ...
  zh: {
    ...
    destCustomLabel: '直接输入目的地', destCustomPlaceholder: '例: 杨平两水头',
    selectOriginFirst: '请先选择出发地和服务类型。',
    minutesUnit: '分钟',
    paxLabel: '人数', vehicleLabel: '车型', recommendedTag: '推荐', maxUnit: '人', groupLabel: '团体',
    ...
    addons: '附加选项', englishGuide: '英文导游', picket: '接机牌', childSeat: '儿童座椅', notes: '要求（选填）',
    ...
    roundTripDiscount: '往返优惠', onewayLabel: '单程',
