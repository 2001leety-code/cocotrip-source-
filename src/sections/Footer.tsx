        ...
        <div className="grid gap-10 md:grid-cols-12">
          ...
          <div className="md:col-span-4">
            ...
            <a
              ...
              className="ec-figure inline-flex items-center gap-2 text-[24px] text-ec-ink transition-colors duration-ec-base ease-ec-standard hover:text-ec-brand"
            >
            ...
            <a
              ...
              className="ec-btn ec-btn-secondary ec-btn-sm mt-5"
            >
