...
const slides = [
  {
    image: '/hero-seoul.webp',
    imageMobile: '/hero-seoul-real.webp', 
    tag: 'slide1.tag',
    title: 'slide1.title',
    subtitle: 'slide1.subtitle',
  },
  {
    image: '/hero-busan.webp',
    imageMobile: '/hero-busan-real.webp',
    tag: 'slide2.tag',
    title: 'slide2.title',
    subtitle: 'slide2.subtitle',
  },
  {
    image: '/hero-gyeongju.webp',
    imageMobile: '/hero-hanok-real.webp',
    tag: 'slide3.tag',
    title: 'slide3.title',
    subtitle: 'slide3.subtitle',
  },
  {
    image: '/hero-danyang.webp',
    imageMobile: '/hero-danyang.webp',
    tag: 'slide4.tag',
    title: 'slide4.title',
    subtitle: 'slide4.subtitle',
  },
  {
    image: '/hero-chuncheon.webp',
    imageMobile: '/hero-chuncheon.webp',
    tag: 'slide5.tag',
    title: 'slide5.title',
...
export function HeroSlider({ t }: HeroSliderProps) {
  ...
  return (
    <section className="relative h-[52vw] min-h-[260px] md:h-screen w-full overflow-hidden">
      {/* Slides */}
            ...
            >
              {index === currentSlide && (
                <>
                  ...
                  <Link
                    to="/planner"
                    className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 text-white font-bold text-base md:text-lg shadow-lg shadow-purple-500/30 hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300"
                  >
                    <Sparkles className="w-5 h-5" /> {t.hero.cta}
                  </Link>
                </>
              )}
            </div>
