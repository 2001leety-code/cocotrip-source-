...
const TOURS_RAW: Tour[] = [
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  {
    ...
    summary: {
      ko: '전등사·강화 인삼한정식·광성보·동막해변 — 강화도 역사와 바다를 잇는 당일 코스',
      en: 'Jeondeungsa Temple · Ganghwa ginseng lunch · Gwangseongbo Fortress · Dongmak Beach — a day of history and coast',
      ja: '伝燈寺・江華人参ランチ・広城堡・東幕海辺 — 歴史と海を巡る江華島日帰りコース',
      zh: '传灯寺·江华人参午餐·广城堡·东幕海边 — 串联历史与海岸的江华岛一日路线',
    },
    description: {
      ko: '전등사에서 강화도의 역사를 만나고 강화 인삼한정식으로 점심을 즐긴 뒤, 해안 요새 광성보와 동막해변을 차례로 둘러보는 하루 일정입니다.',
      en: 'Begin with the history of Jeondeungsa Temple, stop for a Ganghwa ginseng lunch, then continue to coastal Gwangseongbo Fortress and Dongmak Beach.',
      ja: '伝燈寺で江華島の歴史に触れ、江華人参ランチを楽しんだ後、海辺の広城堡と東幕海辺を順に巡る1日コースです。',
      zh: '先在传灯寺了解江华岛历史，享用江华人参午餐后，再依次前往海岸要塞广城堡和东幕海边。',
    },
    priceFrom: 220,
    currency: 'USD',
    durationDays: 1,
    ...
    highlights: [
      ...
      { icon: 'Landmark', text: { ko: '광성보 해안 요새', en: 'Gwangseongbo coastal fortress', ja: '広城堡の海辺の要塞', zh: '广城堡海岸要塞' } },
      { icon: 'Waves', text: { ko: '동막해변 바다 산책', en: 'Dongmak Beach coastal walk', ja: '東幕海辺の海沿い散策', zh: '东幕海边海岸漫步' } },
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  {
    ...
    summary: {
      ko: '임진각·제3땅굴·도라산 전망대·도라산역·통일촌 — 파주 DMZ 역사 현장',
      en: 'Imjingak · 3rd Tunnel · Dorasan Observatory · Dorasan Station · Unification Village — Paju DMZ history',
      ja: '臨津閣・第3トンネル・都羅山展望台・都羅山駅・統一村 — 坡州DMZの歴史を巡るコース',
      zh: '临津阁·第三隧道·都罗山观景台·都罗山站·统一村 — 坡州DMZ历史路线',
    },
    description: {
      ko: '임진각 평화공원에서 출발해 제3땅굴과 도라산 전망대, 도라산역을 둘러보고 통일촌에서 점심을 갖는 파주 DMZ 하루 일정입니다.',
      en: 'Start at Imjingak Peace Park, then visit the 3rd Tunnel, Dorasan Observatory and Dorasan Station before lunch in Unification Village.',
      ja: '臨津閣平和公園から出発し、第3トンネル、都羅山展望台、都羅山駅を巡った後、統一村で昼食をとる坡州DMZの1日コースです。',
      zh: '从临津阁和平公园出发，依次参观第三隧道、都罗山观景台和都罗山站，最后在统一村享用午餐。',
    },
    priceFrom: 230,
    currency: 'USD',
    durationDays: 1,
    ...
    highlights: [
      { icon: 'Flag', text: { ko: '임진각 평화공원', en: 'Imjingak Peace Park', ja: '臨津閣平和公園', zh: '临津阁和平公园' } },
      { icon: 'ArrowDown', text: { ko: '제3땅굴 내부 투어', en: '3rd Infiltration Tunnel interior tour', ja: '第3トンネル内部ツアー', zh: '第三地道内部参观' } },
      { icon: 'Train', text: { ko: '도라산 전망대·도라산역', en: 'Dorasan Observatory & Station', ja: '都羅山展望台・都羅山駅', zh: '都罗山观景台·都罗山站' } },
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  {
    ...
    summary: {
      ko: '불국사·석굴암·경주 한정식·대릉원·동궁과 월지 — 신라 역사 당일 코스',
      en: 'Bulguksa · Seokguram · Gyeongju Hanjeongsik lunch · Daereungwon · Donggung Palace & Wolji Pond — a day of Silla history',
      ja: '仏国寺・石窟庵・慶州韓定食・大陵苑・東宮と月池 — 新羅の歴史を巡る1日コース',
      zh: '佛国寺·石窟庵·庆州韩定食·大陵苑·东宫与月池 — 新罗历史一日路线',
    },
    description: {
      ko: '불국사와 석굴암에서 신라 불교 유산을 살펴보고 경주 한정식으로 점심을 즐긴 뒤, 대릉원·천마총과 동궁과 월지를 차례로 방문합니다.',
      en: 'Explore Silla Buddhist heritage at Bulguksa and Seokguram, stop for Gyeongju Hanjeongsik, then visit Daereungwon and Cheonmachong followed by Donggung Palace and Wolji Pond.',
      ja: '仏国寺と石窟庵で新羅の仏教遺産に触れ、慶州韓定食の昼食後、大陵苑・天馬塚と東宮と月池を順に訪れます。',
      zh: '在佛国寺和石窟庵了解新罗佛教遗产，享用庆州韩定食午餐后，再依次参观大陵苑·天马冢和东宫与月池。',
    },
    priceFrom: 260,
    currency: 'USD',
    durationDays: 1,
    ...
    highlights: [
      ...
      { icon: 'Landmark', text: { ko: '대릉원·천마총', en: 'Daereungwon & Cheonmachong', ja: '大陵苑・天馬塚', zh: '大陵苑·天马冢' } },
      { icon: 'Star', text: { ko: '동궁과 월지', en: 'Donggung Palace & Wolji Pond', ja: '東宮と月池', zh: '东宫与月池' } },
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  {
    ...
    summary: {
      ko: '감천문화마을·자갈치시장·용두산공원·광안리·해운대 — 부산 하이라이트',
      en: 'Gamcheon · Jagalchi Market · Yongdusan Park · Gwangalli · Haeundae — Busan highlights',
      ja: '甘川文化村・チャガルチ市場・龍頭山公園・広安里・海雲台 — 釜山ハイライト',
      zh: '甘川文化村·札嘎其市场·龙头山公园·广安里·海云台 — 釜山精华',
    },
    description: {
      ko: '감천문화마을을 시작으로 자갈치시장에서 점심을 즐기고 용두산공원·부산타워를 둘러본 뒤, 광안리와 해운대 해변으로 이어지는 부산 하루 일정입니다.',
      en: 'Start at Gamcheon Culture Village, have lunch at Jagalchi Market, continue to Yongdusan Park and Busan Tower, then finish with Gwangalli and Haeundae beaches.',
      ja: '甘川文化村から始まり、チャガルチ市場で昼食を楽しみ、龍頭山公園・釜山タワーを巡った後、広安里と海雲台のビーチへ向かう1日コースです。',
      zh: '从甘川文化村出发，在札嘎其市场享用午餐，参观龙头山公园·釜山塔后，再前往广安里和海云台海滩。',
    },
    ...
    highlights: [
      ...
      { icon: 'Waves', text: { ko: '광안리·해운대 해변', en: 'Gwangalli & Haeundae beaches', ja: '広安里・海雲台ビーチ', zh: '广安里·海云台海滩' } },
