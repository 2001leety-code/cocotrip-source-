      ...
      <div className="bg-[#0f1117] border border-cyan-500/25 rounded-2xl w-full max-w-md max-h-[90vh] overflow-y-auto" onClick={e => e.stopPropagation()}>
        ...
        {submitted ? (
          <div className="p-8 text-center">
            ...
            <button onClick={onClose} className="mt-5 px-6 py-2.5 rounded-xl bg-white/10 text-white text-sm hover:bg-white/15 min-h-[44px]">Close</button>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="p-5 space-y-3">
            <div>
              <label className="block text-[13px] uppercase tracking-wider text-white/55 mb-1">Email *</label>
              <input
            ...
            <div className="grid grid-cols-2 gap-2">
              <div>
                <label className="block text-[13px] uppercase tracking-wider text-white/55 mb-1">Name</label>
                <input
              ...
              <div>
                <label className="block text-[13px] uppercase tracking-wider text-white/55 mb-1">Phone / WhatsApp</label>
                <input
            ...
            <div>
              <label className="block text-[13px] uppercase tracking-wider text-white/55 mb-1">Notes (pickup point, special requests)</label>
              <textarea
