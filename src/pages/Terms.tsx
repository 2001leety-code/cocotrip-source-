  ...
  en: {
    ...
    articles: [
      ...
      },
      {
        ...
        list: [
          'Cancellation 24 hours or more before the tour start time: Full refund',
          'Cancellation within 24 hours of the tour start time, or no-show: No refund',
  ...
  ko: {
    ...
    articles: [
      ...
      },
      {
        ...
        list: [
          '투어 시작 24시간 이상 전 취소: 전액 환불',
          '투어 시작 24시간 이내 취소 또는 노쇼: 환불 불가',
  ...
  ja: {
    ...
    articles: [
      ...
      },
      {
        ...
        list: [
          'ツアー開始24時間以上前のキャンセル：全額返金',
          'ツアー開始24時間以内のキャンセルまたはノーショー：返金不可',
