...
const MAP_I18N = {
  en: {
    ...
    noPlansBody: 'Create an AI itinerary and your daily routes will appear here — stops, transit and walking segments on one map.',
    startPlanner: 'Start AI Planner',
    browseTours: 'Browse Tours',
    signInTitle: 'Sign in to see your routes',
    signInBody: 'Your AI itinerary routes are saved to your account.',
    signIn: 'Sign in',
  ...
  ko: {
    ...
    noPlansBody: 'AI 일정을 만들면 날짜별 동선(정거장·대중교통·도보 구간)이 지도에 나타납니다.',
    startPlanner: 'AI 플래너 시작',
    browseTours: '투어 둘러보기',
    signInTitle: '로그인하고 내 동선 보기',
    signInBody: 'AI 일정의 경로는 계정에 저장돼 있어요.',
    signIn: '로그인',
  ...
  ja: {
    ...
    noPlansBody: 'AIプランを作成すると、日別ルート（スポット・交通・徒歩区間）が地図に表示されます。',
    startPlanner: 'AIプランナーを開始',
    browseTours: 'ツアーを見る',
    signInTitle: 'ログインしてルートを見る',
    signInBody: 'AIプランのルートはアカウントに保存されています。',
    signIn: 'ログイン',
  ...
  zh: {
    ...
    noPlansBody: '创建AI行程后，每日路线（景点·交通·步行段）将显示在地图上。',
    startPlanner: '开始AI规划',
    browseTours: '浏览旅游产品',
    signInTitle: '登录后查看我的路线',
    signInBody: 'AI行程的路线已保存到您的账户。',
    signIn: '登录',
