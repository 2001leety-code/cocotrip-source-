...
export default async function handler(req, res) {
  ...
  try {
    ...
    await withStep('routeEnrich', () => runRouteEnrichment(itinerary, { apiKey, body, language, hotel_address: routeHotelAddress, arrival_airport, departure_airport, pax, recommendedZone, recommendedZoneAddress, hotelAddressFromBody: hotel_address, zone_id: blockModeUsed ? (blocksUsed[0] || null) : null }));
