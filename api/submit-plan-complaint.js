 ...
 *
 * 흐름:
 *   1. Body validation (planId + reason 필수, reason 은 5개 enum 만)
 *   2. Firestore plan_complaints 컬렉션에 저장 (planId + reason + detail + reporter + ts)
 *   3. 어드민 텔레그램 booking 채널 알림 (cocotrip bot — admin 가시성)
 *   4. 응답
 *
